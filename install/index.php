...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= $base_url ?>/assets/css/libs/font-awesome.min.css">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="purchase_code" class="form-control form-input" style="resize: vertical; height: 80px;line-height: 24px;padding: 10px;" placeholder="Enter 'codegood' right here!" required></textarea>
                                            </div>
